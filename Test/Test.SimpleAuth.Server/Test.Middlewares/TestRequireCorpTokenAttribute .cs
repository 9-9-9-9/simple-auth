...
namespace Test.SimpleAuth.Server.Test.Middlewares
{
    public class TestRequireCorpTokenAttribute : BaseTestAttribute
    {
        ...
        [TestCase("{\"Corp\": \"c\", \"Version\": 1, \"Header\": \"x-Corp-token\"}", false,
            StatusCodes.Status403Forbidden)]
        [TestCase("{\"Corp\": \"\", \"Version\": 1, \"Header\": \"x-corp-token\"}", false,
            StatusCodes.Status412PreconditionFailed)]
        [TestCase("{\"Corp\": \"c\", \"Version\": 0, \"Header\": \"x-corp-token\"}", false,
            StatusCodes.Status412PreconditionFailed)]
        [TestCase("{\"Corp\": \"c\", \"Version\": 2, \"Header\": \"x-corp-token\"}", false,
